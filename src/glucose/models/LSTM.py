...
class BasicLSTM(BaseModel):
    ...
    def init_network(self, pred_horizons: dict):
        ...
        lay1 = LSTM(32, return_sequences=True, input_shape=(self.len_input, 1))(input1)

        # second layer with 6 neurons
        lay2 = LSTM(16)(lay1)

        # Dropout
        lay3 = Dropout(0.05)(lay2)
...
class BiLSTM(BaseModel):
    ...
    def init_network(self, pred_horizons: dict):
        ...
        # first layer with 32 neurons
        lay1 = Bidirectional(LSTM(128, activation='tanh', input_shape=(self.len_input, 1)))(input1)
    ...
    def compile(self, *args, **kwargs):
        # Create optimizer object and compile the model
        self.model.compile(optimizer=Adam(lr=0.01, decay=0.001),
                           *args,
                           **kwargs)
