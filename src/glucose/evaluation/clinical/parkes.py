...
MODEL_FILE: str = '20200303-094134_RNN_GLUC_MODEL.hdf5'
SCALER_FILE: str = '20200303-094134_RNN_GLUC_SCALER.pkl'
...
for horizon in ['15min', '60min']:
    concat_df = pd.concat([x[horizon] for x in raw_dict.values()])
