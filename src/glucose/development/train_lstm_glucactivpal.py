"""src/glucose/development/train_lstm_glucactivpal.py

This builds a LSTM model based upon the
`models.BasicLSTM` class and then saves it.
It uses the pre constructed train and test data from the glucose
and ActivPal data.
"""
...
CONSTANTS = {
    ...
    'TRAIN_FILE': '20200303-133436_ACTIVPALGCM_train.pkl',
    'VAL_FILE': '20200303-133436_ACTIVPALGCM_tune.pkl',

    'LOOK_BACK': 6,
    'LOOK_FORWARD': [3, 12],
    'PRED_HORIZONS': {'15min': 3, '60min': 12},

    'DATA_COLS': ['glucose', 'x', 'y', 'z'],
    ...
    'VERBOSE_LEVEL': 2,
    'NETWORK_CLASS': BiLSTM,
    'DATA_TYPE': 'glucose_activpal',
}
